...
export default function Special() {
  return (
    <Grid container className={classes.layout} spacing={3}>
          ...
          >
            <Grid item size={{ xs: 12, sm: 6, md: 4 }}>
              ...
              <p className={classes.splImgText}>
                Experience unparalleled wireless freedom with AirPods-your
                perfect companion for immersive sound, seamless connectivity,
                and all-day comfort.
              </p>
